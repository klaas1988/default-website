...
function prima_sidebar_settings_page() {
	...
	<div class="wrap" id="prima-settings">
		...
		<h2 class="nav-tab-wrapper">
			<?php 
				echo '<a href="'.admin_url('themes.php?page=primathemes').'" class="nav-tab">'.__( 'Theme Settings', 'primathemes' ).'</a>';
				...
				if ( current_theme_supports('prima-sidebar-settings') )
					echo '<a href="'.admin_url('themes.php?page=primathemes-sidebars').'" class="nav-tab nav-tab-active">'.__( 'Sidebar Settings', 'primathemes' ).'</a>';
			?>
		</h2>
		
		<?php 	
		$format = '<br/><div id="message" class="updated"><p><strong>%s</strong></p></div>';
