	...
	switch($code){
		...
		case 'prima_products_in_category':
			...
			if ($term !== 0 && $term !== null) {
				...
				return '<p class="info">'.sprintf( __('%s product category does not exist.', 'primathemes'), $atts['category'] ).'</p>';
			}
		break;
		case 'prima_products_in_tag':
			...
			if ($term !== 0 && $term !== null) {
				...
				return '<p class="info">'.sprintf( __('%s product tag does not exist.', 'primathemes'), $atts['tag'] ).'</p>';
			}
		break;
		case 'prima_products_in_attribute':
			...
			if ($term !== 0 && $term !== null) {
				...
				return '<p class="info">'.sprintf( __('%s product attribute does not exist.', 'primathemes'), $atts_orig[$atts['attribute']] ).'</p>';
			}
		break;
